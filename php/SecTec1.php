...
<header >
    ...
    <h1 align="center">Secundaria Tecnica #1</h1>
    <div id="galeria" class="container" align="center" style="margin-top: 40px;">
        <div class="row">
        <div class="col-md-4"><a href="VistaProductoPantalon.php"><?php $_SESSION["pantalon"]=117 ?><img src="../img/14.jpg" alt="">PANTALON</a></div>
            <div class="col-md-4"><a href="VistaProductoPlayera.php"><?php $_SESSION["playera"]=109 ?><img src="../img/13.jpg" alt="">PLAYERA</a></div>
            <div class="col-md-4"><a href="VistaProductoFalda.php"><?php $_SESSION["falda"]=125; $_SESSION["escuela"]=5?><img src="../img/15.jpg" alt="">FALDA</a></div>
