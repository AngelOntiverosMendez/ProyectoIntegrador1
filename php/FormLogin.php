...
<header >
    ...
    <?php
        if(isset($_SESSION["correo"]))
        {
            ...
            <h2 align='center'>Ya tienes una sesion activa, usuario: ".$_SESSION["correo"]."</h2>";

            echo "<h3 align='center'>
            <a href='../scripts/cerrarSesion.php'>[Cerrar Sesion]</a></h3></div>";
        }
        else
        {
    ?> 
    <div class="container" id="contenedor">
      <h2 align=center>Inicio de Sesion</h2>
        ...
        <div align="center">
            <a href="FormAltaCliente.php">Registrate</a>
        </div>
    </div>
    <?php
        }
