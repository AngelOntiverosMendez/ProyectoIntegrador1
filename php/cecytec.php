...
<header >
    ...
    <h1 align="center">CECYTEC</h1>
    <div id="galeria" class="container" align="center" style="margin-top: 40px;">
        <div class="row">
        <div class="col-md-4"><a href="VistaProductoPantalon.php"><?php $_SESSION["pantalon"]=63 ?><img src="../img/8.jpg" alt="">PANTALON</a></div>
            <div class="col-md-4"><a href="VistaProductoPlayera.php"><?php $_SESSION["playera"]=55 ?><img src="../img/7.jpg" alt="">PLAYERA</a></div>
            <div class="col-md-4"><a href="VistaProductoFalda.php"><?php $_SESSION["falda"]=74; $_SESSION["escuela"]=3?><img src="../img/9.jpg" alt="">FALDA</a></div>
        </div>
    </div> 
