...
<header >
    ...
    <h1 align="center">Nueva Laguna</h1>
    <div id="galeria" class="container" align="center" style="margin-top: 40px;">
        <div class="row">
            <div class="col-md-4"><a href="VistaProductoPantalon.php"><?php $_SESSION["pantalon"]=9 ?><img src="../img/2.jpg" alt="">PANTALON</a></div>
            <div class="col-md-4"><a href="VistaProductoPlayera.php"><?php $_SESSION["playera"]=1 ?><img src="../img/1.jpg" alt="">PLAYERA</a></div>
            <div class="col-md-4"><a href="VistaProductoFalda.php"><?php $_SESSION["falda"]=17; $_SESSION["escuela"]=1?><img src="../img/3.jpg" alt="">FALDA</a></div>
        </div>
    </div>   
