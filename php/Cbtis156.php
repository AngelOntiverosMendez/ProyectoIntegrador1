...
<header >
    ...
    <h1 align="center">Cbtis156</h1>
    <div id="galeria" class="container" align="center" style="margin-top: 40px;">
        <div class="row">
        <div class="col-md-4"><a href="VistaProductoPantalon.php"><?php $_SESSION["pantalon"]=33 ?><img src="../img/5.jpg" alt="">PANTALON</a></div>
            <div class="col-md-4"><a href="VistaProductoPlayera.php"><?php $_SESSION["playera"]=25 ?><img src="../img/4.jpg" alt="">PLAYERA</a></div>
            <div class="col-md-4"><a href="VistaProductoFalda.php"><?php $_SESSION["falda"]=44; $_SESSION["escuela"]=2?><img src="../img/6.jpg" alt="">FALDA</a></div>
        </div>
    </div>   
