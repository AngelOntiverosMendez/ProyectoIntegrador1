...
<header >
    ...
    <h1 align="center">Colegio Mijares</h1>
    </div>
    <div id="galeria" class="container" align="center" style="margin-top: 40px;">
        <div class="row">
        <div class="col-md-4"><a href="VistaProductoPantalon.php"><?php $_SESSION["pantalon"]=93 ?><img src="../img/11.jpg" alt="">PANTALON</a></div>
            <div class="col-md-4"><a href="VistaProductoPlayera.php"><?php $_SESSION["playera"]=85 ?><img src="../img/10.jpg" alt="">PLAYERA</a></div>
            <div class="col-md-4"><a href="VistaProductoFalda.php"><?php $_SESSION["falda"]=101; $_SESSION["escuela"]=4?><img src="../img/12.jpg" alt="">FALDA</a></div>
        </div>
    </div>   
